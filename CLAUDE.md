...
**Status: design phase.** There's no code yet. The next steps are verifying Jev details (`docs/jev-docs-checks.md`), settling the owner decisions (`docs/open-questions.md` §1), then build-plan Phase −1 (scaffolding) and Phase 0 (evaluation foundations).
...
| `docs/jev-docs-checks.md` | Checklist of every Jev, TypeSafe and harness assumption that hasn't been verified against the real docs. |
