...
| Q-01-2 | Claude Code plugin layout (`installed_plugins.json`, `enabledPlugins`) is not a stable public contract | Best-effort reader behind `user_level`; failures are warnings | Verify against current Claude Code release in Phase 4 |
